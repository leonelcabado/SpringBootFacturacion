...
public class FacturaController {
	...
	@GetMapping(value = "/cargar-productos/{term}", produces = { "application/json" }) //genera una salida del tipo application/json 
	public @ResponseBody List<Producto> cargarProductos(@PathVariable String term) { //@responseBody evita el parceo a thymeleaf, y genera el json sobre el cuerpo del response
